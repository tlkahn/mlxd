...
const uc_range uc_letter_ranges[UC_LETTER_RANGES_COUNT] = {
...
const uc_range uc_mark_ranges[UC_MARK_RANGES_COUNT] = {
...
const uc_range uc_number_ranges[UC_NUMBER_RANGES_COUNT] = {
